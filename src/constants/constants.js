export const projects = [
  {
    title: 'Cryptocurrency Community Token',
  ...
  {
    title: 'Cryptocurrency Dice Game Token',
  ...
  },
  {
    ...
    description: "Created a full-stack Web3 NFT marketplace powered by the Solidity backend and JavaScript frontend of the site.",
      image: '/images/3.png',
      tags: ['React', 'Solidity', 'Next.js', 'Node.js'],
    source: 'https://marketplaceportfolio.vercel.app',
    visit: 'https://marketplaceportfolio.vercel.app',
    id: 2,
  },
  {
    title: 'ERC20 Price Calculator Webapp',
    description: "Created a webapp with React that calculates the current price for a user-specified amount of supported ERC20 tokens.",
    image: '/images/4.png',
    tags: ['React', 'Solidity'],
    source: 'https://erc20pricecalculator.vercel.app/',
    visit: 'https://erc20pricecalculator.vercel.app/',
    id: 3,
  },
];
